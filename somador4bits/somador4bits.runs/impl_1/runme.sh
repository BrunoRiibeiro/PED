...
HD_PWD='C:/Users/henri/PED/somador4bits/somador4bits.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soma4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soma4.tcl -notrace
